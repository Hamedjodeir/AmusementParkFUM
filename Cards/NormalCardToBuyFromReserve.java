...
public class NormalCardToBuyFromReserve {
    ...
    public NormalCardToBuyFromReserve(int level, Color priceCoinColor1, int priceCoinCount1, Color priceCoinColor2, int priceCoinCount2, Color specialCoinColor)
    {
        setLevel(level);
        ...
        filler2.setMaximumSize(new Dimension(90,20)); // Ensure the max size is respected
        ...
        filler3.setPreferredSize(new Dimension(90, 21));
        filler3.setMaximumSize(new Dimension(90, 21)); // Ensure the max size is respected
